...
- 🏛 기반 연구: [[papers/1351_DeeR-VLA_Dynamic_Inference_of_Multimodal_Large_Language_Mode/review]] — VLA 모델의 하드웨어별 성능 확장 분석이 동적 추론 프레임워크 설계에 중요한 기준점 제공
- 🔗 후속 연구: [[papers/1388_Exploring_Embodied_Multimodal_Large_Models_Development_Datas/review]] — VLA 모델의 cross-platform scaling 연구가 embodied multimodal 모델의 실용적 배포 전략으로 확장
- 🏛 기반 연구: [[papers/1384_EnerVerse_Envisioning_Embodied_Future_Space_for_Robotics_Man/review]] — Multi-agent interaction을 위한 diffusion forcing이 EnerVerse의 embodied future space 예측에 필요한 기술적 기반을 제공한다.
- 🧪 응용 사례: [[papers/1388_Exploring_Embodied_Multimodal_Large_Models_Development_Datas/review]] — embodied multimodal 모델의 cross-platform 배포를 위한 하드웨어별 성능 최적화 전략
- 🔄 다른 접근: [[papers/1447_Latent_Action_Diffusion_for_Cross-Embodiment_Manipulation/review]] — 서로 다른 로봇 플랫폼 간 정책 전이에 대한 contrastive learning과 diffusion co-tuning의 다른 접근법을 보여준다.
- 🔗 후속 연구: [[papers/1565_Scaling_Robot_Learning_with_Semantically_Imagined_Experience/review]] — Cross-platform 비전-언어-액션 모델 확장에서 의미론적 데이터 증강 기법이 일반화 성능 향상에 기여한다.
- 🏛 기반 연구: [[papers/1633_X-VLA_Soft-Prompted_Transformer_as_Scalable_Cross-Embodiment/review]] — Cross-Platform Scaling의 다중 플랫폼 학습이 X-VLA의 cross-embodiment soft prompt 설계 기반이 된다
- 🔗 후속 연구: [[papers/1408_Full-Order_Sampling-Based_MPC_for_Torque-Level_Locomotion_Co/review]] — Diffusion Forcing의 다중 에이전트 상호작용과 DIAL-MPC의 샘플링 방법을 결합하면 복잡한 다중 로봇 제어가 가능하다.
- 🔄 다른 접근: [[papers/1347_D2E_Scaling_Vision-Action_Pretraining_on_Desktop_Data_for_Tr/review]] — Cross-Platform Scaling은 D2E와 유사한 크로스 도메인 확장이지만 웹 스케일 데이터 대신 플랫폼 간 확장에 중점을 둔다
- 🧪 응용 사례: [[papers/1351_DeeR-VLA_Dynamic_Inference_of_Multimodal_Large_Language_Mode/review]] — 동적 추론 프레임워크가 다양한 하드웨어 플랫폼에서 VLA 모델의 실시간 배포 효율성 달성
- 🏛 기반 연구: [[papers/1361_Diffusion_Models_for_Robotic_Manipulation_A_Survey/review]] — Multi-agent interaction을 위한 diffusion forcing 기법이 robotic manipulation diffusion model의 이론적 기반을 확장한다.
