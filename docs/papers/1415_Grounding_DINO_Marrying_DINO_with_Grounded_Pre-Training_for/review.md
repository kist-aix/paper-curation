...
- 🏛 기반 연구: [[papers/1456_LERF_Language_Embedded_Radiance_Fields/review]] — LERF의 언어 임베딩 기반 3D 장면 쿼리 방법론이 Grounding DINO의 open-set detection에 기반이 되는 기술입니다.
- 🏛 기반 연구: [[papers/1454_Learning_Transferable_Visual_Models_From_Natural_Language_Su/review]] — CLIP의 contrastive learning이 Grounding DINO의 vision-language grounding 메커니즘의 핵심 기반 기술입니다.
- 🧪 응용 사례: [[papers/1569_Segment_Anything/review]] — Segment Anything의 segmentation 기술과 결합하여 더 정밀한 grounded object detection을 구현할 수 있습니다.
- 🔗 후속 연구: [[papers/1454_Learning_Transferable_Visual_Models_From_Natural_Language_Su/review]] — CLIP의 contrastive learning 방법론이 Grounding DINO의 vision-language grounding에 핵심적으로 적용됩니다.
- 🧪 응용 사례: [[papers/1456_LERF_Language_Embedded_Radiance_Fields/review]] — Grounding DINO의 open-set detection 기술을 3D NeRF 환경에서 자연어 쿼리로 활용한 구체적 응용 사례입니다.
- 🏛 기반 연구: [[papers/1569_Segment_Anything/review]] — Grounded Pre-training과 결합된 DINO 모델이 SAM의 프롬프트 기반 분할 능력을 보완한다.
- 🔗 후속 연구: [[papers/1365_DINOv2_Learning_Robust_Visual_Features_without_Supervision/review]] — Grounding DINO가 DINOv2의 self-supervised visual feature를 grounded pre-training으로 확장한다.
