...
- 🔄 다른 접근: [[papers/1516_Plan-Seq-Learn_Language_Model_Guided_RL_for_Solving_Long_Hor/review]] — 장기 로봇 스킬 획득에서 언어 가이드 증류 방식과 PSL의 LLM-계획-RL 통합 방식을 데이터 효율성 관점에서 비교할 수 있다.
- 🏛 기반 연구: [[papers/1578_SPRINT_Scalable_Policy_Pre-Training_via_Language_Instruction/review]] — SPRINT의 대규모 정책 사전학습과 instruction relabeling 방법론이 언어 가이드 로봇 스킬 확장 및 증류에 이론적 기반을 제공한다.
- 🔗 후속 연구: [[papers/1362_Diffusion_Policy_Visuomotor_Policy_Learning_via_Action_Diffu/review]] — Diffusion Policy의 visuomotor 정책 학습을 다중 작업 언어 조건 환경으로 확장하여 더 복잡한 로봇 스킬 증류를 가능하게 한다.
- 🧪 응용 사례: [[papers/1435_HAFO_A_Force-Adaptive_Control_Framework_for_Humanoid_Robots/review]] — Instruct2Act의 멀티모달 명령 매핑 방법론을 언어 가이드 로봇 스킬 획득에 적용하여 실제 로봇 환경에서의 명령 이해 능력을 향상시킬 수 있다.
- 🔄 다른 접근: [[papers/1462_LOTUS_Continual_Imitation_Learning_for_Robot_Manipulation_Th/review]] — LOTUS와 언어 가이드 스킬 증류 모두 지속적 스킬 학습을 다루지만, 비지도 기술 발견 vs 언어 기반 스킬 전이라는 서로 다른 접근법을 사용한다
- 🔄 다른 접근: [[papers/1516_Plan-Seq-Learn_Language_Model_Guided_RL_for_Solving_Long_Hor/review]] — 장기 로봇 작업 해결에서 PSL의 LLM-motion planning-RL 통합 방식과 언어 가이드 스킬 증류 방식의 차이점을 비교할 수 있다.
- 🔗 후속 연구: [[papers/1578_SPRINT_Scalable_Policy_Pre-Training_via_Language_Instruction/review]] — 언어 가이드 로봇 스킬 증류 방법론을 SPRINT의 cross-trajectory skill chaining에 통합하여 더 복잡한 스킬 조합을 학습할 수 있다.
- 🏛 기반 연구: [[papers/1321_Bootstrap_Your_Own_Skills_Learning_to_Solve_New_Tasks_with_L/review]] — 기존 스킬의 조합을 통한 새로운 능력 획득이라는 BOSS의 핵심 아이디어가 언어 가이드 스킬 증류 방법론에 이론적 기반을 제공한다
