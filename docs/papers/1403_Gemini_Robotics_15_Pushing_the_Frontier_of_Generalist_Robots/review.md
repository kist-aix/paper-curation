...
- 🏛 기반 연구: [[papers/1391_Fast-in-Slow_A_Dual-System_Foundation_Model_Unifying_Fast_Ma/review]] — Gemini Robotics의 motion transfer 메커니즘이 dual-system VLA 모델 설계의 기초 아이디어 제공
- 🔗 후속 연구: [[papers/1404_Gemini_Robotics_Bringing_AI_into_the_Physical_World/review]] — Gemini Robotics 1.5의 고도화된 기능이 기본 Gemini Robotics 모델의 직접적 발전
- 🏛 기반 연구: [[papers/1395_FlowPolicy_Enabling_Fast_and_Robust_3D_Flow-based_Policy_via/review]] — consistency flow matching 기반 빠른 정책 생성이 Gemini Robotics의 실시간 제어 기반
- 🏛 기반 연구: [[papers/1404_Gemini_Robotics_Bringing_AI_into_the_Physical_World/review]] — Gemini Robotics의 기본 VLA 구조가 1.5 버전의 advanced 기능 개발 토대
- 🔗 후속 연구: [[papers/1391_Fast-in-Slow_A_Dual-System_Foundation_Model_Unifying_Fast_Ma/review]] — Fast-in-Slow 구조가 Gemini Robotics의 motion transfer와 embodied thinking 능력으로 확장
- 🔗 후속 연구: [[papers/1409_GR-2_A_Generative_Video-Language-Action_Model_with_Web-Scale/review]] — GR-2의 대규모 비디오 학습이 Gemini Robotics의 embodied reasoning 능력 강화로 연결
