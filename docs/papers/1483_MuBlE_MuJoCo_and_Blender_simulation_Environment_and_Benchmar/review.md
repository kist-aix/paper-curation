...
- 🔄 다른 접근: [[papers/1469_ManiSkill3_GPU_Parallelized_Robotics_Simulation_and_Renderin/review]] — 둘 다 GPU 가속 시뮬레이션을 제공하지만 1483은 MuJoCo+Blender 조합으로, 1469는 순수 GPU 병렬화로 접근함
- 🔗 후속 연구: [[papers/1527_Real2Render2Real_Scaling_Robot_Data_Without_Dynamics_Simulat/review]] — MuBlE의 시각-물리 통합 환경을 실제 객체 스캔 데이터로 확장하여 더 현실적인 시뮬레이션을 구현함
- 🧪 응용 사례: [[papers/1577_MolmoSpaces_A_Large-Scale_Open_Ecosystem_for_Robot_Navigatio/review]] — MolmoSpaces의 대규모 환경이 MuBlE의 시각-물리 통합 시뮬레이션의 실제 적용 사례를 보여줨
- 🔗 후속 연구: [[papers/1469_ManiSkill3_GPU_Parallelized_Robotics_Simulation_and_Renderin/review]] — ManiSkill3의 GPU 병렬화 시뮬레이션을 MuJoCo+Blender 조합으로 확장하여 더 현실적인 시각 렌더링을 추가함
- 🏛 기반 연구: [[papers/1527_Real2Render2Real_Scaling_Robot_Data_Without_Dynamics_Simulat/review]] — MuBlE의 현실적인 시각-물리 통합 환경이 스마트폰 스캔 기반 데이터 생성의 기반을 제공함
