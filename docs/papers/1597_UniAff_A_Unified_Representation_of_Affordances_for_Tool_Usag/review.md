...
- 🔄 다른 접근: [[papers/1543_RoboPoint_A_Vision-Language_Model_for_Spatial_Affordance_Pre/review]] — UniAff는 3D constraints 기반으로, RoboPoint는 spatial affordance prediction으로 도구 사용과 객체 조작의 affordance를 다루는 다른 접근법
- 🔗 후속 연구: [[papers/1301_A3VLM_Actionable_Articulation-Aware_Vision_Language_Model/review]] — UniAff의 통일된 affordance 표현이 A3VLM의 actionable articulation 인식과 결합되어 더 정교한 관절 객체 조작을 가능하게 함
- 🏛 기반 연구: [[papers/1340_Context-Aware_Entity_Grounding_with_Open-Vocabulary_3D_Scene/review]] — UniAff의 affordance 기반 조작이 Context-Aware Entity Grounding의 3D scene understanding을 기반으로 더 정확한 spatial reasoning을 수행
- 🔗 후속 연구: [[papers/1468_ManipVQA_Injecting_Robotic_Affordance_and_Physically_Grounde/review]] — 도구 사용을 위한 통합 affordance 표현을 로봇 조작의 물리적 이해와 결합하여 더욱 포괄적인 능력을 구현할 수 있습니다.
- 🏛 기반 연구: [[papers/1301_A3VLM_Actionable_Articulation-Aware_Vision_Language_Model/review]] — UniAff는 A3VLM의 affordance 인식 개념을 도구 사용을 위한 통합 표현으로 확장한 이론적 기반을 제공한다
