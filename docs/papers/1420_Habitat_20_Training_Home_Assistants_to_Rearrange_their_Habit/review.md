...
- 🔄 다른 접근: [[papers/1317_BEHAVIOR-1K_A_Human-Centered_Embodied_AI_Benchmark_with_1000/review]] — 가정용 로봇 벤치마크를 다른 태스크와 환경 구성으로 제시한다
- 🏛 기반 연구: [[papers/1412_GaussGym_An_open-source_real-to-sim_framework_for_learning_l/review]] — 로봇 학습을 위한 고성능 시뮬레이션 환경의 기반을 제공한다
- 🔗 후속 연구: [[papers/1430_iGibson_10_a_Simulation_Environment_for_Interactive_Tasks_in/review]] — 상호작용 가능한 실내 환경을 물체 재배치 태스크로 특화 발전시켰다
- 🏛 기반 연구: [[papers/1430_iGibson_10_a_Simulation_Environment_for_Interactive_Tasks_in/review]] — interactive 실내 환경의 기본 프레임워크와 데이터셋을 제공한다
- 🔗 후속 연구: [[papers/1412_GaussGym_An_open-source_real-to-sim_framework_for_learning_l/review]] — 물리 시뮬레이션 플랫폼을 photorealistic rendering으로 확장했다
- 🔗 후속 연구: [[papers/1317_BEHAVIOR-1K_A_Human-Centered_Embodied_AI_Benchmark_with_1000/review]] — 가정용 로봇 시뮬레이션을 더 포괄적인 일상 활동으로 확장한 벤치마크다
- 🏛 기반 연구: [[papers/1577_MolmoSpaces_A_Large-Scale_Open_Ecosystem_for_Robot_Navigatio/review]] — Habitat 2.0의 가정용 보조 로봇 환경이 대규모 실내 로봇 시뮬레이션 생태계의 기반을 제공함
