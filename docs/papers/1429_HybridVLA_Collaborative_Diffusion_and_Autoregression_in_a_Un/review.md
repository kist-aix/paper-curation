...
- 🏛 기반 연구: [[papers/1362_Diffusion_Policy_Visuomotor_Policy_Learning_via_Action_Diffu/review]] — Diffusion Policy의 연속성과 HybridVLA의 diffusion 기반 action 예측이 직접적인 방법론적 연관성을 갖는다.
- 🔄 다른 접근: [[papers/1519_Pure_Vision_Language_Action_VLA_Models_A_Comprehensive_Surve/review]] — VLA 모델에서 diffusion과 autoregression의 통합 방식에 대한 서로 다른 체계적 접근을 보여준다.
- 🔗 후속 연구: [[papers/1580_MOSAIC_Bridging_the_Sim-to-Real_Gap_in_Generalist_Humanoid_M/review]] — Streaming Flow Policy의 단순화된 diffusion 접근법과 HybridVLA의 복합적 접근법이 상호 보완적이다.
- 🔗 후속 연구: [[papers/1519_Pure_Vision_Language_Action_VLA_Models_A_Comprehensive_Surve/review]] — VLA 모델의 포괄적 분류와 diffusion-autoregression 통합이 VLA 접근법의 확장된 이해를 제공한다.
