...
- 🏛 기반 연구: [[papers/1403_Gemini_Robotics_15_Pushing_the_Frontier_of_Generalist_Robots/review]] — Gemini Robotics의 기본 VLA 구조가 1.5 버전의 advanced 기능 개발 토대
- 🔄 다른 접근: [[papers/1409_GR-2_A_Generative_Video-Language-Action_Model_with_Web-Scale/review]] — Gemini 2.0 기반 접근과 web-scale 사전학습 기반 generative 모델의 서로 다른 VLA 전략
- 🔗 후속 연구: [[papers/1403_Gemini_Robotics_15_Pushing_the_Frontier_of_Generalist_Robots/review]] — Gemini Robotics 1.5의 고도화된 기능이 기본 Gemini Robotics 모델의 직접적 발전
