...
- 🔄 다른 접근: [[papers/1320_BitVLA_1-bit_Vision-Language-Action_Models_for_Robotics_Mani/review]] — VLA 모델 경량화의 다른 접근법으로 1비트 양자화와 소형 아키텍처 설계를 비교할 수 있다.
- 🔗 후속 연구: [[papers/1577_SpecPrune-VLA_Accelerating_Vision-Language-Action_Models_via/review]] — 빠른 추론과 데이터 효율성에서 소형 VLA와 토큰 프루닝이 상호 보완적 최적화를 제공한다.
- 🏛 기반 연구: [[papers/1510_OpenVLA_An_Open-Source_Vision-Language-Action_Model/review]] — 오픈소스 VLA 모델의 경량화 버전으로 실제 배포 가능한 효율적 대안을 제시한다.
- 🔄 다른 접근: [[papers/1392_FAST_Efficient_Action_Tokenization_for_Vision-Language-Actio/review]] — TinyVLA의 data-efficient approach가 FAST의 고주파 제어에 특화된 tokenization과 다른 효율성 접근을 제시한다.
- 🔗 후속 연구: [[papers/1510_OpenVLA_An_Open-Source_Vision-Language-Action_Model/review]] — 고속 데이터 효율적 VLA 모델 설계를 OpenVLA의 7B 파라미터 구조 최적화에 적용하여 배포 효율성을 향상시킬 수 있다
- 🏛 기반 연구: [[papers/1577_SpecPrune-VLA_Accelerating_Vision-Language-Action_Models_via/review]] — 경량 VLA 모델의 빠른 추론에서 토큰 프루닝이 데이터 효율성과 함께 배포 성능을 최적화한다.
- 🔗 후속 연구: [[papers/1616_VLA-Adapter_An_Effective_Paradigm_for_Tiny-Scale_Vision-Lang/review]] — TinyVLA의 소형 모델 설계 철학을 adapter 기반 학습으로 더욱 발전시킨 접근법이다
- 🔗 후속 연구: [[papers/1320_BitVLA_1-bit_Vision-Language-Action_Models_for_Robotics_Mani/review]] — TinyVLA의 fast, data-efficient 접근법이 BitVLA의 1-bit 압축과 결합되어 더욱 경량화된 VLA 모델을 구현할 수 있다.
- 🔗 후속 연구: [[papers/1327_CEED-VLA_Consistency_Vision-Language-Action_Model_with_Early/review]] — TinyVLA의 데이터 효율적 학습이 CEED-VLA의 4배 가속화와 결합되어 더욱 실용적인 VLA 시스템을 구현할 수 있다.
