...
- 🔗 후속 연구: [[papers/1552_RoboTwin_Dual-Arm_Robot_Benchmark_with_Generative_Digital_Tw/review]] — RoboTwin의 generative digital twin 개념을 MLLM 기반 자동 코드 생성과 대규모 데이터 생성이 가능한 확장 가능한 프레임워크로 발전시킨다.
- 🏛 기반 연구: [[papers/1407_Genie_Generative_Interactive_Environments/review]] — Genie의 generative interactive environment 개념을 로봇 조작 영역에서 실제 적용 가능한 데이터 생성 시스템으로 구현한다.
- 🔄 다른 접근: [[papers/1409_GR-2_A_Generative_Video-Language-Action_Model_with_Web-Scale/review]] — 대규모 로봇 데이터 생성에서 web-scale 데이터 활용과 시뮬레이션 기반 생성이라는 서로 다른 전략을 제시한다.
- 🏛 기반 연구: [[papers/1552_RoboTwin_Dual-Arm_Robot_Benchmark_with_Generative_Digital_Tw/review]] — 기본적인 generative digital twin 프레임워크를 MLLM과 자동화된 파이프라인을 통해 더욱 확장 가능한 시스템으로 발전시킨다.
