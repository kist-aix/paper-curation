...
- 🏛 기반 연구: [[papers/1494_In-N-On_Scaling_Egocentric_Manipulation_with_in-the-wild_and/review]] — 대규모 egocentric 데이터셋 구축 방법론이 HWM의 학습 데이터 확장에 직접적으로 활용 가능하다
- 🔗 후속 연구: [[papers/1291_3D-VLA_A_3D_Vision-Language-Action_Generative_World_Model/review]] — 3D Vision-Language-Action 통합 모델 구조를 HWM의 세계 모델에 적용하여 공간 이해 능력을 강화할 수 있다
- 🧪 응용 사례: [[papers/1412_GR00T_N1_An_Open_Foundation_Model_for_Generalist_Humanoid_Ro/review]] — GaussGym의 실시간 물리 시뮬레이션 환경이 HWM의 실제 배포 검증에 필수적이다
