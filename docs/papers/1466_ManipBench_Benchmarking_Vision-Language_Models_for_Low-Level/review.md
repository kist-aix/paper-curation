...
- 🔗 후속 연구: [[papers/1468_ManipVQA_Injecting_Robotic_Affordance_and_Physically_Grounde/review]] — VLM의 저수준 조작 추론 평가를 affordance와 물리적 이해가 주입된 모델로 발전시킨 형태입니다.
- 🧪 응용 사례: [[papers/1301_A3VLM_Actionable_Articulation-Aware_Vision_Language_Model/review]] — articulation-aware 비전 언어 모델이 저수준 로봇 조작 추론의 실제 구현에 필요한 기술을 제공합니다.
- 🏛 기반 연구: [[papers/1518_Prismatic_VLMs_Investigating_the_Design_Space_of_Visually-Co/review]] — 시각적으로 조건화된 언어 모델의 기본 구조가 로봇 조작을 위한 VLM 평가의 토대가 됩니다.
- 🔗 후속 연구: [[papers/1268_An_Empirical_Evaluation_of_Four_Off-the-Shelf_Proprietary_Vi/review]] — 상업적 VLM들의 경험적 평가를 로봇 조작 특화 벤치마크로 확장하여 더욱 구체적인 성능 분석을 제공합니다.
- 🏛 기반 연구: [[papers/1468_ManipVQA_Injecting_Robotic_Affordance_and_Physically_Grounde/review]] — VLM의 로봇 조작 추론 능력 평가가 affordance 인식과 물리적 이해 주입의 필요성을 보여줍니다.
