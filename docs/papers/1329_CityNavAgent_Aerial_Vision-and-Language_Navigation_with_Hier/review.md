...
- 🔄 다른 접근: [[papers/1280_Being-0_A_Humanoid_Robotic_Agent_with_Vision-Language_Models/review]] — Being-0는 CityNavAgent와 유사한 계층적 구조를 가지지만 인간형 로봇을 위한 지상 환경에 특화되어 있다
- 🏛 기반 연구: [[papers/1508_Kinematics-Aware_Multi-Policy_Reinforcement_Learning_for_For/review]] — Openfly는 CityNavAgent의 aerial VLN을 위한 종합적인 공중 시각-언어 플랫폼 기반을 제공한다
- 🔗 후속 연구: [[papers/1577_MolmoSpaces_A_Large-Scale_Open_Ecosystem_for_Robot_Navigatio/review]] — MolmoSpaces는 CityNavAgent의 공간 계획을 대규모 오픈 생태계로 확장한다
- 🔄 다른 접근: [[papers/1280_Being-0_A_Humanoid_Robotic_Agent_with_Vision-Language_Models/review]] — CityNavAgent는 드론 환경에서 유사한 계층적 의미 계획을 사용하지만 다른 구현체를 활용한다
- 🔗 후속 연구: [[papers/1486_Multimodal_Perception_for_Goal-oriented_Navigation_A_Survey/review]] — 항공 시각-언어 네비게이션과 지상 goal-oriented navigation의 multimodal perception 기법이 상호 보완적이다.
- 🔗 후속 연구: [[papers/1507_OpenBench_A_New_Benchmark_and_Baseline_for_Semantic_Navigati/review]] — CityNavAgent의 aerial vision-language navigation이 OpenBench의 마지막 배송 구간 네비게이션을 공중 시점으로 확장한다.
- 🧪 응용 사례: [[papers/1595_TRAVEL_Training-Free_Retrieval_and_Alignment_for_Vision-and-/review]] — TRAVEL의 topological mapping 접근법이 CityNavAgent의 hierarchical planning과 함께 대규모 도시 환경 네비게이션에 적용 가능
- 🔄 다른 접근: [[papers/1470_Humanoid_Parkour_Learning/review]] — 둘 다 동적 전신 움직임을 다루지만 Parkour는 파쿠르에, Deep Whole-body Parkour는 일반적 파쿠르에 집중한다
