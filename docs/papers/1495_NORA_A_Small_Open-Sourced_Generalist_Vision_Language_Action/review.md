...
- 🔄 다른 접근: [[papers/1320_BitVLA_1-bit_Vision-Language-Action_Models_for_Robotics_Mani/review]] — VLA 모델의 경량화에서 3B 파라미터와 1-bit quantization이라는 서로 다른 효율성 향상 접근법을 보여준다.
- 🔗 후속 연구: [[papers/1588_OKAMI_Teaching_Humanoid_Robots_Manipulation_Skills_through_S/review]] — TinyVLA와 NORA가 모두 소형 VLA 모델로서 빠르고 데이터 효율적인 로봇 제어의 상호 보완적 접근을 제시한다.
- 🧪 응용 사례: [[papers/1574_Mobi-π_Mobilizing_Your_Robot_Learning_Policy/review]] — 모바일 환경에서의 로봇 정책 실행과 소형 VLA 모델의 실시간 제어 능력이 직접적으로 연결된다.
