...
- 🧪 응용 사례: [[papers/1287_π_0_A_Vision-Language-Action_Flow_Model_for_General_Robot_Co/review]] — VLA 모델의 구조적 분석을 π0의 실제 구현에 적용하여 설계 원리를 검증한다
- 🔗 후속 연구: [[papers/1300_A_Survey_on_Vision-Language-Action_Models_for_Autonomous_Dri/review]] — 일반적인 VLA 구조 분석을 자율주행이라는 특화 도메인으로 확장하여 적용한다
- 🏛 기반 연구: [[papers/1519_Pure_Vision_Language_Action_VLA_Models_A_Comprehensive_Surve/review]] — pure VLA 모델의 포괄적 조사가 VLA 구조 분석의 이론적 토대를 제공한다
- 🏛 기반 연구: [[papers/1287_π_0_A_Vision-Language-Action_Flow_Model_for_General_Robot_Co/review]] — VLA 모델의 구조적 분석이 π0의 vision-language-action flow model 설계에 이론적 기초를 제공한다
- 🔗 후속 연구: [[papers/1247_A_Survey_of_Behavior_Foundation_Model_Next-Generation_Whole-/review]] — VLA 모델의 구조적 분석을 토대로 전신 제어를 위한 행동 기초 모델의 발전 방향을 구체화한다
- 🏛 기반 연구: [[papers/1446_Large_VLM-based_Vision-Language-Action_Models_for_Robotic_Ma/review]] — Vision-Language-Action 모델의 모듈별 해부학적 분석이 VLA 아키텍처 이해의 기반을 제공한다.
- 🏛 기반 연구: [[papers/1300_A_Survey_on_Vision-Language-Action_Models_for_Autonomous_Dri/review]] — VLA 모델의 구조적 분석이 자율주행 특화 VLA 모델 설계의 이론적 기초를 제공한다
