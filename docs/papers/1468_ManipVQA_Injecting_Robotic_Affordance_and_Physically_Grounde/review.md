...
- 🏛 기반 연구: [[papers/1466_ManipBench_Benchmarking_Vision-Language_Models_for_Low-Level/review]] — VLM의 로봇 조작 추론 능력 평가가 affordance 인식과 물리적 이해 주입의 필요성을 보여줍니다.
- 🔗 후속 연구: [[papers/1597_UniAff_A_Unified_Representation_of_Affordances_for_Tool_Usag/review]] — 도구 사용을 위한 통합 affordance 표현을 로봇 조작의 물리적 이해와 결합하여 더욱 포괄적인 능력을 구현할 수 있습니다.
- 🏛 기반 연구: [[papers/1543_RoboPoint_A_Vision-Language_Model_for_Spatial_Affordance_Pre/review]] — 공간적 affordance 예측이 물리적으로 그라운딩된 조작 이해의 핵심 구성 요소를 제공합니다.
- 🧪 응용 사례: [[papers/1611_PhysDiff_Physics-Guided_Human_Motion_Diffusion_Model/review]] — 시각적 지시 튜닝 방법론이 로봇 affordance와 물리적 개념을 MLLM에 효과적으로 주입하는 데 활용됩니다.
- 🔗 후속 연구: [[papers/1466_ManipBench_Benchmarking_Vision-Language_Models_for_Low-Level/review]] — VLM의 저수준 조작 추론 평가를 affordance와 물리적 이해가 주입된 모델로 발전시킨 형태입니다.
- 🔗 후속 연구: [[papers/1301_A3VLM_Actionable_Articulation-Aware_Vision_Language_Model/review]] — ManipVQA는 A3VLM의 affordance 개념을 로봇 조작을 위한 물리적 근거가 있는 질의응답으로 확장한다
