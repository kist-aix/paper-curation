...
- 🏛 기반 연구: [[papers/1386_Evaluating_Real-World_Robot_Manipulation_Policies_in_Simulat/review]] — GRUtopia 대규모 시뮬레이션 환경이 SIMPLER와 같은 정책 평가 벤치마크의 확장 기반 제공
- 🔗 후속 연구: [[papers/1407_Genie_Generative_Interactive_Environments/review]] — Genie의 생성형 환경 아이디어가 GRUtopia의 대규모 3D 도시 시뮬레이션으로 구체화
- 🔗 후속 연구: [[papers/1359_DualTHOR_A_Dual-Arm_Humanoid_Simulation_Platform_for_Conting/review]] — DualTHOR 플랫폼이 GRUtopia 대규모 환경에서 dual-arm 작업의 scalability 검증으로 확장
- 🏛 기반 연구: [[papers/1407_Genie_Generative_Interactive_Environments/review]] — Genie의 생성형 인터랙티브 환경이 GRUtopia 대규모 시뮬레이션 도시 구축의 생성 모델 기반
- 🧪 응용 사례: [[papers/1499_OmniVLA_An_Omni-Modal_Vision-Language-Action_Model_for_Robot/review]] — 일반목적 휴머노이드 제어를 위한 파운데이션 모델이 OmniVLA의 multi-platform 일반화 검증에 실제 환경을 제공한다
- 🧪 응용 사례: [[papers/1386_Evaluating_Real-World_Robot_Manipulation_Policies_in_Simulat/review]] — SIMPLER 환경을 GRUtopia 대규모 도시 환경에서 정책 평가 벤치마크로 확장 적용
- 🔗 후속 연구: [[papers/1413_GBC_Generalized_Behavior-Cloning_Framework_for_Whole-Body_Hu/review]] — 통합 행동 복제 프레임워크가 GRUtopia 대규모 환경에서 다양한 로봇 형태 지원으로 확장
