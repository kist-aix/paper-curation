...
- 🔄 다른 접근: [[papers/1406_Genie_Envisioner_A_Unified_World_Foundation_Platform_for_Rob/review]] — Genie Envisioner의 video diffusion 기반 통합 플랫폼이 EnerVerse의 chunk-wise autoregressive approach와 다른 방식으로 embodied future를 다룬다.
- 🏛 기반 연구: [[papers/1346_Cross-Platform_Scaling_of_Vision-Language-Action_Models_from/review]] — Multi-agent interaction을 위한 diffusion forcing이 EnerVerse의 embodied future space 예측에 필요한 기술적 기반을 제공한다.
- 🔗 후속 연구: [[papers/1290_3D_Gaussian_Splatting_for_Real-Time_Radiance_Field_Rendering/review]] — 3D Gaussian Splatting 기술이 EnerVerse의 4D Gaussian Splatting 기반 data flywheel을 확장한다.
- 🔄 다른 접근: [[papers/1406_Genie_Envisioner_A_Unified_World_Foundation_Platform_for_Rob/review]] — EnerVerse의 chunk-wise autoregressive approach와 달리 Genie Envisioner는 단일 video generation framework로 통합한다.
