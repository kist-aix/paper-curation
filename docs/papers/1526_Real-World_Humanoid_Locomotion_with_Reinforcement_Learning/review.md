...
- 🏛 기반 연구: [[papers/1534_Learning_Sim-to-Real_Humanoid_Locomotion_in_15_Minutes/review]] — 15분 만에 sim-to-real 보행 학습을 달성한 효율적인 학습 방법론이 대규모 강화학습의 실용적 적용 가능성을 입증함
- 🔗 후속 연구: [[papers/1476_Humanoid_World_Models_Open_World_Foundation_Models_for_Human/review]] — 휴머노이드 월드 모델의 개념을 실제 환경에서의 제로샷 배포가 가능한 구체적인 locomotion 정책으로 구현한 형태임
- 🏛 기반 연구: [[papers/1328_Chain-of-Action_Trajectory_Autoregressive_Modeling_for_Robot/review]] — 이족 보행을 위한 심층 강화학습의 이론적 배경과 방법론적 토대를 제공함
- 🏛 기반 연구: [[papers/1459_HuMam_Humanoid_Motion_Control_via_End-to-End_Deep_Reinforcem/review]] — HuMam의 end-to-end RL 프레임워크는 real-world humanoid locomotion의 실용적 구현에 필요한 기반 기술을 제공한다.
